...
import { RegistroPbiExamenDTO, RegistroPbiExamenRespuestaDTO } from 'src/app/Models/ExamenDTO';
...
export class ExamenService {
  ...
  public Registrar(Json:RegistroPbiExamenDTO):Observable<any>{
  ...
  public RegistrarRespuestaSeleccion(Json:RegistroPbiExamenRespuestaDTO):Observable<any>{
  ...
  public ObtenerMejorExamenPorUsuario(Json:RegistroPbiExamenDTO):Observable<any>{
